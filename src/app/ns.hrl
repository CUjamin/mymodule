...
-define(REDIS_HOST, <<"urn:xmpp:mucsub:nodes:system">>).
-define(REDIS_PORT, <<"urn:xmpp:mucsub:nodes:system">>).
-define(MONGO_HOST, <<"urn:xmpp:mucsub:nodes:system">>).
-define(MONGO_PORT, <<"urn:xmpp:mucsub:nodes:system">>).
-define(PRE_RPOJ_ONLINE_USERS, <<"urn:xmpp:mucsub:nodes:system">>).
-define(USER_PRESENCE, <<"urn:xmpp:mucsub:nodes:system">>).
